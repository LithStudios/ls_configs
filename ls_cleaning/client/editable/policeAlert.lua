...
RegisterNetEvent('ls_cleaning:activatePoliceAlarm')
AddEventHandler('ls_cleaning:activatePoliceAlarm', function(locationCoords)
...
RegisterNetEvent('ls_cleaning:TriggerDispatchMessage')
AddEventHandler('ls_cleaning:TriggerDispatchMessage', function(eventCoords)
